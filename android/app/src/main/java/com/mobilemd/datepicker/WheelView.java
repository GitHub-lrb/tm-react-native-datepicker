...
public class WheelView extends View{
            ...
            Handler handler = new Handler() {
                ...
                public void handleMessage(Message msg) {
                    ...
                    if (msg.what == touchEventId) {
                        if (mlastY == mScroller.getCurrY()) {
                            //停止了，此处你的操作业务
                            if (mListener != null)
                            {
                                mListener.onDidSelect(getCenterItem());
                            }
                        } else {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (eventAction) {
                    case MotionEvent.ACTION_UP:
                        ...
                        handler.sendMessageDelayed(handler.obtainMessage(touchEventId, v), 50);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(unit,width/2+40,getBaseLine(paint,centerItemTop,itemHeight),paint);
    ...
    public Object getCenterItem(){
        int nowChecked = getCurrentIndex();
